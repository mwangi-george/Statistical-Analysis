...
In the previous examples, the models had one numeric and one categorical explanatory variable. In this section we will check what changes if we have two numeric explanatory variables instead.
